...
$classes = Flux::classes()
    ...
    ->add(match ($variant) { // Background color...
        'primary' => 'bg-primary hover:bg-[color-mix(in_oklab,_var(--color-accent),_transparent_10%)]',
    ...
    ->add(match ($variant) { // Button group styles...
        'ghost' => '',
        'subtle' => '',
    ...
    ->add($loading ? [ // Loading states...
        '*:transition-opacity',
        '[&>*:not(.flux-icon)]:data-loading:opacity-0 [&>*:not(.flux-icon)]:data-flux-loading:opacity-0',
        '.flux-icon:not([data-loading]):not([data-flux-loading]):opacity-0',
