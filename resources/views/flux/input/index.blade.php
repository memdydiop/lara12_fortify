...
$classes = Flux::classes()
    ->add('w-full border rounded block disabled:shadow-none')
    ->add('appearance-none') // Without this, input[type="date"] on mobile doesn't respect w-full...
    ->add(match ($size) {
        default => 'text-base sm:text-sm py-2 h-8 leading-[1.375rem]', // This makes the height of the input 40px (same as buttons and such...)
